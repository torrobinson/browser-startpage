...
function updateClock() {
	...
	if (greeting) {
		...
		if (hours >= 6 && hours < 12) greetingMessage = 'Good Morning';
		else if (hours >= 12 && hours < 16) greetingMessage = 'Good Afternoon';
		else if (hours >= 16 && hours < 20) greetingMessage = 'Good Evening';
		else if (hours >= 20 || hours < 6) greetingMessage = 'Good Night';
